...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="de" suppressHydrationWarning>
      <body className="min-h-screen bg-[#0a0a0a] dark:bg-[#0a0a0a] light:bg-white text-white dark:text-white light:text-zinc-900 antialiased">
        <Providers>
          <Navbar />
          <main>{children}</main>
          <footer className="border-t border-[#2a2a2a] dark:border-[#2a2a2a] light:border-zinc-200 mt-20">
