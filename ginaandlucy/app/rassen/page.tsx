...
export default function RassenPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 py-12">
      ...
      {/* Maine Coon Section */}
      <motion.section className="mb-20" initial={false} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }}>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {maineCoonTraits.map((trait, i) => (
            <motion.div key={trait.labelDe} initial={false} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.05 * i }}>
      ...
      {/* Siamese Section */}
      <motion.section className="mb-20" initial={false} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
        <div className="h-px bg-border mb-8" />
      ...
      {/* Comparison Table */}
      <motion.section initial={false} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }}>
